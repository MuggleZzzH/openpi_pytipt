...
python convert_pi0_to_hf_lerobot.py \
    --checkpoint_dir /zhaohan/ZJH/openpi/openpi-assets/checkpoints/pi0_base/params \
    --output_path /zhaohan/ZJH/openpi_pytorch/checkpoints/pi0_libero_test_pytorch
...
def convert_pi0_checkpoint(
    ...
    # --- Sanitize device string (allow "cuda", "cuda:0", "cuda:1" -> "cuda", keep "cpu"/"mps") ---
    torch_device_clean = torch_device.split(":")[0]
    ...
    pi0_config.device = torch_device_clean
