...
while not d:
    ...
    base_0_rgb = to_hwc_hmirror(o["agentview_image"])
    left_wrist_0_rgb = to_hwc_hmirror(o["robot0_eye_in_hand_image"])
    ...
    for i in range(50):
        ...
        # 保存视频帧：统一到 HWC，并做水平镜像（不换通道）
        frames.append(to_hwc_hmirror(o["agentview_image"]))
        if d:
            break
